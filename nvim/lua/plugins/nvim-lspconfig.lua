return {
	...
	config = function()
		...
		-- Mason setup (must come before registry access)
		require("mason").setup()
		require("mason-lspconfig").setup({
			ensure_installed = { "clangd", "ty", "ruff", "lua_ls", "rust_analyzer", "ts_ls", "vue_ls" },
		})

		local vue_plugin_path = require("mason-core.installer.InstallLocation")
			.global()
			:package("vue-language-server") .. "/node_modules/@vue/typescript-plugin"
